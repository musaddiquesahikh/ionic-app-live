...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    PurchaseInvoicePageRoutingModule,TranslateModule
  ],
  declarations: [PurchaseInvoicePage, ShowItemPage, PartyListPage, CreateNewItemPage, AddNewPartyPage ,InvoiceBetaPage]
})
